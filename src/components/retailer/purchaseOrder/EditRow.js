...
const EditRow = ({index, order, distributorName}) => {
    const [total, setTotal] = useState(parseFloat(order.amount) * parseFloat(order.price));
            ...
            <td>
                <Form.Group>
                    ...
                    <FormControl.Feedback type={"invalid"}>
                        <strong>
                            Amount cant exceed available quantity
                        </strong>
                    ...
                    <Button disabled={updateBtnDisabled} onClick={handleUpdate}>Update</Button>
